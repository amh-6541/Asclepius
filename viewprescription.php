                ...
                <tbody>
                    <?php
                        try{
                            ...
                            $sqlquery="";
                            if(!empty($searchval)){
                                $sqlquery="SELECT * FROM prescription_upload AS pu JOIN customer AS c ON pu.CustomerEmail=c.Email where CustomerEmail='$searchval'";
                            }
                                    ...
                                    ?>
                                        <tr>
											...
											<td><a href="<?php echo $row['Prescription'] ?>"download>
                                                <img width="150" height="150" alt="No prescription found" src="<?php echo $row['Prescription'] ?>"></a>
                                            </td>
