<?php
 ...
 if(isset($_POST["add_to_cart"]) && isset($_GET['param1']) && !empty($_GET['param1']))
 {
...
$query= "SELECT * FROM medical_components where Component_details LIKE '%$searchval1%' || Component_Name LIKE '%$searchval1%'";
